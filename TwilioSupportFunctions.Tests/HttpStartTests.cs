...
namespace TwilioSupportFunctions.Tests
{
    ...
    {
        [Fact]
        public async Task HttpStart_returns_retyrafter_header()
        {
            ...
            var result = await ProcessNumbersStarter.StartPeriodicTask(
                new HttpRequestMessage()
                {
                    Content = new StringContent("{}", Encoding.UTF8, "application/json"),
                    RequestUri = new Uri("http://localhost:7071/orchestrators/CallSupportNumbers"),
                },
                clientMock.Object,
                loggerMock.Object);
